...
<body class="body_load">
    ...
    <img class='img_car' src="../images/car.png"><div id="car_mileage"><b>Rok:</b> <?php echo $year ?><br/> <b>Pojemność:</b> <?php echo $capacity ?><br/> <b>Moc:</b> <?php echo $power ?><br/> <b>Wynajem:</b><br/> <?php echo $start ?> <b>do</b> <?php echo $end ?></div>

    
    <a href='delete_car.php'><img class='delete_car' src='../images/trash.png'></a>
</body>
